...
export default function DynamicButton({
  ...
  return (
    <button
      onClick={onClick}
      className={`flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl font-medium transition-all duration-300 active:scale-95 shadow-md cursor-pointer text-sm sm:text-base
        ${
          theme === "dark"
