...
export default function CreateTask() {
  ...
  return (
    <div >
      <div className="md:min-w-[800px] md:min-w-2/3 p-0 mt-20 md:mt-0 overflow-hidden rounded-[20px] bg-white dark:bg-darkBG border-none shadow-2xl">
        
        <div className="px-10 py-6 border-b border-gray-100 dark:border-gray-400 dark:border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-2.5">
              ...
              <select name="assignedTo" value={formData.assignedTo} onChange={handleChange} className="w-full h-12 px-4 rounded-xl border border-gray-400 dark:border-gray-200 bg-transparent text-sm outline-none focus:ring-1 focus:ring-textOrange dark:focus:ring-teal-300">
                <option value="select member" className='dark:bg-black'>select member</option>
                <option value="Tahira"        className='dark:bg-black'>Tahira</option>
                <option value="Tabassum"      className='dark:bg-black'>Tabassum</option>
              </select>
            </div>
          </div>
        </div>

        <div className="px-10 py-8 bg-muted/5 flex justify-center items-center gap-4 sm:justify-center">
          <Button variant="ghost"  className="h-12 px-12 rounded-xl bg-gray-200 hover:bg-gray-300 text-gray-700 font-bold transition-all">
            Cancel
          </Button>
          <Button onClick={handleCreate} className="h-12 px-12 rounded-xl bg-textOrange dark:bg-teal-500 hover:bg-textOrange/90 text-white font-bold transition-all">
            Create
          </Button>
        </div>
      </div>
