    ...
    return (
      <div className="flex flex-col items-center justify-center h-80 border-2 border-dashed border-border rounded-[32px] bg-muted/5">
        ...
        <p className="text-muted-foreground font-semibold">
          Select an order to view project overview
        </p>
      </div>
    );
  }
    ...
    <div>
      <div className="w-full space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <div className="bg-white dark:bg-darkSecBG rounded-[32px] border border-border p-6 md:p-10 shadow-sm">
          ...
          <div className="relative mb-10 group">
            ...
            <p className="text-foreground/70 text-[15px] leading-relaxed font-medium pl-2">
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-base md:text-md font-black text-foreground">
                      {metric.value}
                    </p>
                  </div>
                </div>
            ...
            <div className="p-5 rounded-[24px] border border-border bg-muted/5 dark:bg-muted/10 hover:border-orange-500/30 dark:hover:border-teal-500/30 transition-all duration-300">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-base md:text-md font-black text-foreground">
                    {findProject.assign_member_count} Members
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className=" mt-12 space-y-6 animate-in fade-in duration-500">
        {/* Top Action Bar */}
          ...
          <ul className="flex   items-start sm:items-center gap-4 bg-white dark:bg-darkSecBG p-4 rounded-2xl border border-border shadow-sm">
            <li>
              <NavLink
                to="tasklist"
                className={({ isActive }) =>
                  isActive
                    ? " px-6 py-2 rounded-lg text-sm font-bold font-bold bg-orange-100 dark:bg-teal-500/10 border border-orange-300 dark:border-teal-300 text-orange-600 dark:text-teal-400"
                    : "px-6 py-2 rounded-lg text-sm font-bold border border-orange-300 dark:border-teal-300"
                }
              >
                Task List
              </NavLink>
            ...
            <li>
              <NavLink
                ...
                className={({ isActive }) =>
                  isActive
                    ? " px-6 py-2 rounded-lg text-sm font-bold font-bold bg-orange-100 dark:bg-teal-500/10 text-orange-600 dark:text-teal-400 border border-orange-300 dark:border-teal-300"
                    : " px-6 py-2 rounded-lg text-sm font-bold border border-orange-300 dark:border-teal-300"
                }
              >
                Messages
