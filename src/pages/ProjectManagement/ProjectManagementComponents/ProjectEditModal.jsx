...
export default function ProjectEditModal() {
        ...
        if (id && projectsData) {
            ...
            if (projectToEdit) {
                setFormData({
                    ...
                    timeline: projectToEdit.deadline || "",
                    orderId: projectToEdit.orderId || `ORD-${id}`,
                    team: projectToEdit.team || "",
                    type: projectToEdit.type || "",
                    status: projectToEdit.status || "Active",
                    totalValue: projectToEdit.value || "",
                    phases: projectToEdit.phases || [],
                    files: [], // Files usually need re-uploading
                });
            }
        }
    }, [id]);
    ...
    return (
        <div className={`min-h-screen ${theme === "dark" ? "bg-[#0B1220] text-white" : "bg-white text-gray-900"}`}>
            ...
            <h1 className="text-xl font-bold mb-8">Edit Project: {id}</h1>
